...
class RevIchimokuSmugPlugControllerConfig(DirectionalTradingControllerConfigBase):
    controller_name = "rev_ichismugplug"
...
class RevIchimokuSmugPlugController(DirectionalTradingControllerBase):

    def __init__(self, config: RevIchimokuSmugPlugControllerConfig, *args, **kwargs):
        self.config = config
